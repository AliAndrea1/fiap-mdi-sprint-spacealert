  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.acoes}>
        ...
        <TouchableOpacity style={[styles.acaoBtn, styles.acaoBtnLimpar]} onPress={limparHistorico}>
          <Text style={styles.acaoBtnText}>🗑️</Text>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  acaoBtnLimpar: { flex: 0, width: 40, paddingHorizontal: 0 },
  acaoBtnText: { fontSize: 11, color: Colors.text, fontWeight: '600' },
  ...
  notifLida: { opacity: 0.5 },
  notifDot: { width: 10, height: 10, borderRadius: 5, marginRight: 12 },
  notifInfo: { flex: 1 },
  notifTituloRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  notifTitulo: { fontSize: 13, fontWeight: '600', color: Colors.text, flex: 1 },
  textLido: { color: Colors.textSecondary },
  tagUsuario: {
    fontSize: 9, color: Colors.primary, fontWeight: 'bold',
    borderWidth: 1, borderColor: Colors.primary,
    paddingHorizontal: 4, paddingVertical: 1, borderRadius: 4,
  },
  notifData: { fontSize: 11, color: Colors.textSecondary, marginTop: 2 },
  notifBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
  notifBadgeText: { fontSize: 10, fontWeight: 'bold', color: Colors.text },
  vazio: { alignItems: 'center', paddingTop: 80 },
  vazioEmoji: { fontSize: 48, marginBottom: 16 },
  vazioText: { fontSize: 16, color: Colors.textSecondary },
  modalOverlay: {
  ...
  modalTitulo: { fontSize: 18, fontWeight: 'bold', color: Colors.text, marginBottom: 4 },
  ...
  inputErro: { borderColor: Colors.emergencia },
  erro: { fontSize: 12, color: Colors.emergencia, marginBottom: 12 },
  nivelRow: { flexDirection: 'row', gap: 8, marginBottom: 16 },
  nivelBtn: {
    flex: 1, padding: 10, borderRadius: 8,
    borderWidth: 1.5, alignItems: 'center',
  },
  nivelBtnText: { fontSize: 12, fontWeight: '600', color: Colors.textSecondary },
  sucessoBox: {
    backgroundColor: Colors.safe + '22', borderRadius: 10,
    padding: 12, marginBottom: 12,
    borderWidth: 1, borderColor: Colors.safe,
  },
  sucessoText: { color: Colors.safe, fontSize: 13, fontWeight: '600', textAlign: 'center' },
  modalBotoes: { flexDirection: 'row', gap: 12, marginTop: 8 },
  botao: { flex: 1, padding: 14, borderRadius: 10, alignItems: 'center' },
  botaoCancelar: { backgroundColor: Colors.cardSecondary },
  botaoSalvar: { backgroundColor: Colors.primary },
  botaoText: { color: Colors.text, fontSize: 15, fontWeight: 'bold' },
});